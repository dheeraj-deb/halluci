    ...
    <Layout>
      ...
      <section className="featured">
        <div className="container">
          <article style={{backgroundImage: 'url(/images/baghome.jpg)'}} className="featured-item featured-item-large">
          ...
          <article style={{backgroundImage: 'url(/images/shoehome.jpg)'}} className="featured-item featured-item-small-first">
            <div className="featured-item__content">
              <h3>SHOES</h3>
